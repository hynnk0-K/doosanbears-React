      ...
      <div className="layout_fix">
        <div className="signUp_layout">
          ...
          <ul className="step_bar">
            <li className="agreement step step1 on"><button type='button' className='btn'>약관동의</button></li> 
            <li className="information step step2"><button type='button' className='btn'>정보입력</button></li>
            <li className="success step step3"><button type='button' className='btn'>회원가입 완료</button></li>
          </ul>
          <form id='input_form' style={{textAlign: 'left'}} action="#" method="post" name="signup" onSubmit={handleSubmit}>
            <div className="input_form">
              ...
              <ul className='check_box round small'>
                <li role='presentation'>
                  <input type="checkbox" readonly="" id='agree02' />
              ...
              <div class="line_box p_14_24 mt_40">
                <ul class="check_box round">
                  <li role="presentation">
                    <input type="checkbox" readonly="" id='agreeAll'/>
                    <label htmlFor="agreeAll"><span>전체 동의합니다.</span></label>
                  </li>
                </ul>
              </div>
